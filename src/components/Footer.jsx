              ...
              <div className="group">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col">
                    <span className="text-xs text-white/50 mb-1">Željko Stojaković:</span>
                    <a href="tel:+381638072937" className="hover:text-[var(--color-accent-light)] transition-colors text-base font-medium flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href="tel:+38163529064" className="hover:text-[var(--color-accent-light)] transition-colors text-base font-medium flex items-center gap-2">
                      <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      +381 63 529 064
